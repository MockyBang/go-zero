...
import (
    ...
    "github.com/globalsign/mgo/bson"
     {{if .Cache}}cachec "github.com/MockyBang/go-zero/core/stores/cache"
	"github.com/MockyBang/go-zero/core/stores/mongoc"{{else}}"github.com/MockyBang/go-zero/core/stores/mongo"{{end}}
)
